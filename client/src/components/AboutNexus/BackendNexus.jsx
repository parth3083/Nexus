  ...
  return (
    <div className='one w-full h-[100vh] flex  md:flex-row flex-col items-center justify-between py-5 px-[3.75vw] bg-[#2A2828]'>
                <div className='one-left-1 w-full md:w-[55%] h-full flex flex-col md:items-start items-center justify-start md:justify-start'>
                    ...
                    <span className='w-fit -mt-[5vw] md:-mt-[2vw] mb-[0.5vw] overflow-hidden  inline-block '><h3 className=' font-loaderend1 text-[2.45vw] md:text-[1.37vw] translate-y-[100%]'>For the backend, NEXUS leverages Node.js, a JavaScript runtime environment that </h3></span>
