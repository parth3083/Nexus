    ...
    return (
        <div className='one w-full h-[100vh] md:flex-row  flex flex-col-reverse items-center justify-between py-5 px-[3.75vw]'>
            ...
            <div className="nright  w-full md:w-[55%] h-full pt-5 items-center justify-start flex flex-col md:items-end md:justify-start">
                ...
                <span className='w-fit -mt-[4vw] mb-[0.5vw] md:mt-[2vw] md:mb-[0.5vw] overflow-hidden  inline-block '><h3 className=' font-loaderend1 text-[2.43vw] md:text-[1.35vw] translate-y-[100%]'>Nexus is a web application built to simplify image sorting. Using React.js for its user</h3></span>
